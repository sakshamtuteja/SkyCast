...
//7266a533b577002ee1bca7e3304eb81f
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetachWeatherData(cityName:String) {
        ...
        val response = retrofit.getWeatherData(cityName,"7266a533b577002ee1bca7e3304eb81f","metric")
    ...
    private fun changeimageweather(conditions:String) {
        when (conditions){
            "Haze","Partly Clouds","Mist","Foggy","Clouds"->{
